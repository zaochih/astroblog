...
const zhCnUi = {
    ...
    'toast.switch': '切换',
    'toast.dismiss': '关闭',
    'footer.builtWith': '自豪地由 <a href="https://astro.build" target="_blank" rel="noopener" class="hover:text-primary transition-colors">Astro</a> 与 <a href="https://tailwindcss.com" target="_blank" rel="noopener" class="hover:text-primary transition-colors">Tailwind CSS</a> 提供动力。',
    ...
    'friends.referral': '推介',
    'friends.timeLimited': '限时活动',
    'pagination.prev': '← 上一页',
    'pagination.next': '下一页 →',
    'rss.title': '全部文章',
    'aria.skipToContent': '跳到正文',
    'aria.nav.main': '主导航',
    'aria.nav.home': '前往首页',
    'aria.nav.search': '搜索站内内容',
    'aria.pagination': '分页导航',
    'aria.sidebar.profile': '作者信息',
    'aria.sidebar.taxonomy': '分类和标签',
...
export const ui: UiMap = {
  ...
  'en-us': {
    ...
    'footer.builtWith': 'Proudly powered by <a href="https://astro.build" target="_blank" rel="noopener" class="hover:text-primary transition-colors">Astro</a> & <a href="https://tailwindcss.com" target="_blank" rel="noopener" class="hover:text-primary transition-colors">Tailwind CSS</a>.',
    ...
    'friends.referral': 'Referral',
    'friends.timeLimited': 'Limited-time',
    ...
    'aria.sidebar.profile': 'Author profile',
    'aria.sidebar.taxonomy': 'Categories and tags',
